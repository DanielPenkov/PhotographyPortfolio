...
;(function ($, w, undefined) {
		...
		function load(isInit) {
			...
			if (itemNav) {
				...
				$items.each(function (i, element) {
					...
					var itemSize = round(o.horizontal ? (rect.width + 0.8) || rect.right - rect.left : rect.height || rect.bottom - rect.top);
	...
	Sly.defaults = {
		...
		activateMiddle: null, // Always activate the item in the middle of the FRAME. forceCentered only.
		...
		disabledClass: 'hidden' // Class for disabled navigation elements.
	};
}(jQuery, window));
